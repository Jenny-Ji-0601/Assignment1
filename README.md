...
The R version needed for this project is 4.5.1 (2025-06-13). To reproduce the analysis, you need to install the following R packages: tidyverse, skimr, ggplot2, glue, and KableExtra.
After loading and placing the dataset, you can run the scripts and data wrangling and visualisation functions.

# Where users can get help with your project
If you encounter issues or have questions, you can email dtnvxj6@ucl.ac.uk.
